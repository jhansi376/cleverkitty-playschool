$path = "c:\Users\jhans\Downloads\playschool\about\our-team.html"
$content = Get-Content $path -Raw
$startMarker = "<!-- FOOTER -->"
$endMarker = "</footer>"
$newFooter = @"
    <!-- FOOTER: V2 "Enchanted Garden" -->
...
$newContent = $content.Substring(0, $startIndex) + $newFooter + $content.Substring($endIndex)
Set-Content -Path $path -Value $newContent -Encoding UTF8
Write-Host "Updated footer successfully."
